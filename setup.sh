...
sudo -u $USER $ENV/bin/pip install django djangorestframework -e git+https://github.com/MaTachi/django-userena.git#egg=django-userena django-breadcrumbs Pillow django-widget-tweaks
